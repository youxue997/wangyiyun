<template>
<div class="header">
    <audio src="src/assets/musics/yessir.m4a" id="music1"></audio>
    <div class="bg"></div>
    <div class="banner">
    ...
    <div class="middle">
        <img src="../../assets/images/012.jpg" class="img1">
        <img src="../../assets/images/012.png" alt="">
        <img src="../../assets/images/010.png" class="img2">
    </div>
    <div class="footer">
      <span>0:00</span>
       <input id="snrPollInterval" type="range" min="1" max="30">
       <span>3:42</span>
       <p><span class="iconfont icon-xunhuan"></span>
...
.header .bg{
    background-image: url(../../assets/images/012.jpg);
    position: absolute;
    left: 0px;
    top: 0px;
    right: 0px;
...
.footer{
    width: 100%;
    height: 120px;
    /* background: rgba(150, 146, 146, 0.6); */
    position: relative;
    /* z-index: 11; */
    top: 450px;
    text-align: center;
